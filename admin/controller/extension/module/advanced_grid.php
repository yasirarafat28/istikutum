...
class ControllerExtensionModuleAdvancedGrid extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/advanced_grid', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/advanced_grid', 'token=' . $this->session->data['token'], true);
		...
		foreach ($directories as $directory) {
			...
			$files_latest_blogs = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/extension/module/advanced_grid/latest_blogs/*.tpl');
			$files_links = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/extension/module/advanced_grid/links/*.tpl');
			$files_newsletter = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/extension/module/advanced_grid/newsletter/*.tpl');
			$files_products = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/extension/module/advanced_grid/products/*.tpl');
			$files_products_tabs = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/extension/module/advanced_grid/products_tabs/*.tpl');
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Advanced Grid',
			'href' => $this->url->link('extension/module/advanced_grid', 'token=' . $this->session->data['token'], true)
		);
