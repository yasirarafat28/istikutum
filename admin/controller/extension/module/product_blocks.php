...
class ControllerExtensionModuleProductBlocks extends Controller {
	...
	public function index() {   
		$this->language->load('extension/module/product_blocks');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/product_blocks', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/product_blocks', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Product Blocks',
			'href' => $this->url->link('extension/module/product_blocks', 'token=' . $this->session->data['token'], true)
		);
		...
		$this->response->setOutput($this->load->view('extension/module/product_blocks', $data));
	}
	
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/product_blocks')) {
