...
//end revsslider custom code
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/revslideropencart', 'token=' . $this->session->data['token'], true),
			'separator' => ' :: '
		);
// start language
...
// end language
		...
		$data['action'] = $this->url->link('extension/module/revslideropencart', 'token=' . $this->session->data['token'], true);
		...
		$this->template = 'extension/module/revslideropencart.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
...
//end revsslider custom code
	...
	public function install(){
		$this->load->model('module/revslideropencart');
		$this->model_module_revslideropencart->setup();
		$ABSPATH = get_url();
	...
	public function uninstall(){
		$this->load->model('module/revslideropencart');
		$this->model_module_revslideropencart->remove();
	}
