...
class ControllerExtensionModuleRevolutionSlider extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/revolution_slider', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['placement'] = $this->url->link('extension/module/revolution_slider', 'token=' . $this->session->data['token'], true);		
		$data['existing'] = $this->url->link('extension/module/revslideropencart', 'token=' . $this->session->data['token'], true);		
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/revolution_slider', 'token=' . $this->session->data['token'], true)
		);
