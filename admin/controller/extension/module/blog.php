...
class ControllerExtensionModuleBlog extends Controller {
    ...
    private function addBasicLang($array = array())
    {
        ...
        $data['link_blog_dashboard'] = $this->url->link('extension/module/blog', 'token=' . $this->session->data['token'], true);
        $data['link_add_edit_categories'] = $this->url->link('extension/module/blog/category_list', 'token=' . $this->session->data['token'], true);
        $data['link_add_edit_articles'] = $this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'], true);
        $data['link_add_edit_authors'] = $this->url->link('extension/module/blog/author_list', 'token=' . $this->session->data['token'], true);
        $data['link_add_edit_comments'] = $this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'], true);
        $data['link_general_settings'] = $this->url->link('extension/module/blog/settings', 'token=' . $this->session->data['token'], true);
        
        $data['link_blog_category'] = $this->url->link('extension/module/blog_category', 'token=' . $this->session->data['token'], true);
        $data['link_blog_search'] = $this->url->link('extension/module/blog_search', 'token=' . $this->session->data['token'], true);
        $data['link_blog_latest_post'] = $this->url->link('extension/module/blog_latest', 'token=' . $this->session->data['token'], true);
        $data['link_blog_popular_post'] = $this->url->link('extension/module/blog_popular', 'token=' . $this->session->data['token'], true);
        $data['link_blog_product_related_post'] = $this->url->link('extension/module/blog_related_post', 'token=' . $this->session->data['token'], true);
        $data['link_blog_popular_tags'] = $this->url->link('extension/module/blog_tags', 'token=' . $this->session->data['token'], true);
	...
	public function article_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateArticleForm()) {
			...
			$this->response->redirect($this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getArticlesList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'], true)
		);

		$data['add'] = $this->url->link('extension/module/blog/article_add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/blog/article_delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['articles'][] = array(
				...
				'author'  => '<a target="_blank" href="'.$this->url->link('extension/module/blog/author_list', 'token=' . $this->session->data['token'] . '&author_id=' . $result['author_id'] . $url, true).'">'.$result['author'] .'</a>',
                'comments'    => $this->model_blog_comment->getTotalArticleComments($result['article_id']),
				'edit'        => $this->url->link('extension/module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $result['article_id'] . $url, true),
				'delete'      => $this->url->link('extension/module/blog/article_delete', 'token=' . $this->session->data['token'] . '&article_id=' . $result['article_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'] . '&sort=title' . $url, true);
		$data['sort_date_published'] = $this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'] . '&sort=date_published' . $url, true);
		$data['sort_author'] = $this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'] . '&sort=author' . $url, true);
		...
		$pagination->url = $this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getArticleForm() {
		...
		if (!isset($this->request->get['article_id'])) {
			$data['action'] = $this->url->link('extension/module/blog/article_add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $this->request->get['article_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/blog/article_list', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function category_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCategoryForm()) {
			...
			$this->response->redirect($this->url->link('extension/module/blog/category_list', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getCategoriesList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/blog/category_list', 'token=' . $this->session->data['token'], true)
		);

		$data['add'] = $this->url->link('extension/module/blog/category_add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/blog/category_delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'edit'        => $this->url->link('extension/module/blog/category_edit', 'token=' . $this->session->data['token'] . '&category_id=' . $result['category_id'] . $url, true),
				'delete'      => $this->url->link('extension/module/blog/category_delete', 'token=' . $this->session->data['token'] . '&category_id=' . $result['category_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('extension/module/blog/category_list', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('extension/module/blog/category_list', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('extension/module/blog/category_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getCategoryForm() {
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('extension/module/blog/category_add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/blog/category_edit', 'token=' . $this->session->data['token'] . '&category_id=' . $this->request->get['category_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/blog/category_list', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function comment_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCommentForm()) {
			...
			$this->response->redirect($this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getCommentList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'], true)
		);
        
		$data['add'] = $this->url->link('extension/module/blog/comment_add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/blog/comment_delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['comments'][] = array(
                ...
                'article_href'     => $this->url->link('extension/module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $result['article_id'], true),
				'edit'            => $this->url->link('extension/module/blog/comment_edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $result['comment_id'] . $url, true)
			);
		...
		$data['sort_name'] = $this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_email'] = $this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=email' . $url, true);
		$data['sort_date_added'] = $this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, true);
		$data['sort_status'] = $this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('extension/module/blog/comment_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getCommentForm() {
		...
		if (!isset($this->request->get['comment_id'])) {
			$data['action'] = $this->url->link('extension/module/blog/comment_add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/blog/comment_edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->request->get['comment_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/blog/comment', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $data['article_href'] = $this->url->link('extension/module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $comment_info['article_id'], true);
	...
	public function author_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateAuthorForm()) {
			...
			$this->response->redirect($this->url->link('extension/module/blog/author_list', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getAuthorList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/blog/author_list', 'token=' . $this->session->data['token'], true)
		);
        
		$data['add'] = $this->url->link('extension/module/blog/author_add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/blog/author_delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['authors'][] = array(
				...
				'name'            => $result['name'],
				'sort_order'      => $result['sort_order'],
				'edit'            => $this->url->link('extension/module/blog/author_edit', 'token=' . $this->session->data['token'] . '&author_id=' . $result['author_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('extension/module/blog/author_list', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('extension/module/blog/author_list', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('extension/module/blog/author_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getAuthorForm() {
		...
		if (!isset($this->request->get['author_id'])) {
			$data['action'] = $this->url->link('extension/module/blog/author_add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/blog/author_edit', 'token=' . $this->session->data['token'] . '&author_id=' . $this->request->get['author_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/blog/author', 'token=' . $this->session->data['token'] . $url, true);
    ...
    // SETTIGNGS
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSettingsForm()) {
			...
			$this->response->redirect($this->url->link('extension/module/blog/settings', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getSettingsForm() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/blog/settings', 'token=' . $this->session->data['token'], true)
		);

        $data['action'] = $this->url->link('extension/module/blog/settings', 'token=' . $this->session->data['token'] . $url, true);
		$data['cancel'] = $this->url->link('extension/module/blog', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($directories as $directory) {
			...
			$files_article_list = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/blog/article_list/*.tpl');
			$files_article_detail = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/blog/article_detail/*.tpl');
			$files_article_related = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/blog/article_related/*.tpl');
