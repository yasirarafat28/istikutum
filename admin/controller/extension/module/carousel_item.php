...
class ControllerExtensionModuleCarouselItem extends Controller {
	...
	public function index() {   
		$this->language->load('extension/module/carousel_item');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/carousel_item', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/carousel_item', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Carousel item',
			'href' => $this->url->link('extension/module/carousel_item', 'token=' . $this->session->data['token'], true)
		);
		...
		$this->response->setOutput($this->load->view('extension/module/carousel_item', $data));
	}
	
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/carousel_item')) {
