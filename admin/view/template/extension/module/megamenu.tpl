					...
					<ul class="skins">
						...
						<li>
							<select name="megamenu_modules">
								...
								<option  style="font-size: 12px !important" <?php if($active_module_id == $module['id']) { echo ' selected="selected"'; } ?> value="<?php echo $module['id']; ?>"><?php echo $module['name']; ?></option>
								<?php } ?>
							</select>
						</li>
					...
					<div class="background clearfix">
						...
						<div class="right">
							...
							<div class="input clearfix">
								...
								<input type="text" name="label_text_color" id="label_text_color" value="<?php if(isset($label_text_color)) echo $label_text_color; ?>">
								<div class="color_selected" <?php if(isset($label_text_color)) { if($label_text_color != '') { echo 'style="background: ' . $label_text_color . '"'; } } ?>></div>
							</div>
							...
							<div class="input clearfix">
								...
								<input type="text" name="label_background_color" id="label_background_color" value="<?php if(isset($label_background_color)) echo $label_background_color; ?>">
								<div class="color_selected" <?php if(isset($label_background_color)) { if($label_background_color != '') { echo 'style="background: ' . $label_background_color . '"'; } } ?>></div>
							</div>
							...
							<div class="input clearfix">
								...
								<div class="language">
									<?php $language_id = $language['language_id']; ?>
									<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />
									<input type="text" name="link[<?php echo $language_id; ?>]" <?php if(isset($link[$language_id]) && is_array($link)) { echo 'value="'.$link[$language_id].'"'; } else if(isset($link) && !is_array($link)) { echo 'value="'.$link.'"'; } ?>>
								</div>
								<?php } ?>
								</div>
							</div>
							...
							<div class="input clearfix">
								<p>Submenu width</p>
								<input type="text" name="submenu_width" value="<?php echo $submenu_width; ?>"> <div>Example: 100%, 260px</div>
							</div>
							...
							<div id="content_type1"<?php if($content_type != '1') { ?> style="display:none"<?php } ?> class="content_type">
								...
								<div class="input clearfix">
									...
									<input type="text" name="content[product][width]" value="<?php if(isset($content['product']['width'])) echo $content['product']['width']; ?>" style="width: 60px; margin-right: 0px">
									<span style="display: block;float: left; padding:7px 15px 0px 7px">px</span>
									<input type="text" name="content[product][height]" value="<?php if(isset($content['product']['height'])) echo $content['product']['height']; ?>" style="width: 60px; margin-right: 0px">
									<span style="display: block;float: left; padding:7px 15px 0px 7px">px</span>
								</div>
							</div>
						...
						<div class="right">
							...
							<div class="input clearfix">
								<p>Animation Time</p>
								<input type="text" name="animation_time" style="width:60px;margin-right:10px" value="<?php echo $animation_time; ?>">
								<div>ms</div>
							</div>
							...
							<div class="input clearfix">
								...
								<input type="text" name="cache_time" style="width:60px;margin-right:10px" value="<?php echo $cache_time; ?>">
								<div>h</div>
							</div>
...
$(document).ready(function() {
	...
	$('#links_autocomplete').autocomplete({
		...
		source: function(request, response) {		
			$.ajax({
				url: 'index.php?route=extension/module/megamenu/autocomplete&token=<?php echo $_GET['token']; ?>&filter_name=' +  encodeURIComponent(request),
				dataType: 'json',
				success: function(json) {
					response($.map(json, function(item) {
						return {
	...
	function menu_updatesort(jsonstring) {
	     $.post("index.php?route=extension/module/megamenu&token=<?php echo $_GET['token']; ?>&module_id=<?php echo $active_module_id; ?>", {
