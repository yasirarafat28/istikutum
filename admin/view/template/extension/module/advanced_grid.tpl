						...
						<?php foreach ($modules as $module) { $column_count = $columns_count; ?>
						  <div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
						   	<div id="tab-module-<?php echo $module_row; ?>-tabs" class="module-tabs">
						   		<a href="#tab-module-<?php echo $module_row; ?>-settings">Module <br>Settings</a>
						   		...
						   		<?php $column_count++; } } ?>
                                <span class="column-add"  onclick="addcolumn(<?php echo $module_row; ?>);" ><img src="view/image/module_template/add.png" alt=""/>Add<br> Column</span>
						   	</div>
                              		...
                              		<table class="form">
                                		...
                                		<tr>
                                  			...
                                  			<td class="color_input">
                                                <input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][background_color]" class="colorpicker-input" value="<?php echo $module['background_color']; ?>" />
                                                <span class="color_selected" <?php if($module['background_color'] != '') echo 'style="background: ' . $module['background_color'] . '"'; ?> ></span>
                                            </td>
                                		</tr>
                                		<tr>
                                        ...
                                        <?php if(isset($column['module'])) { $s = 1; foreach($column['module'] as $column_module) { ?>
						   	          ...
						   	          <?php } ?>
						   	          				...
						   	          				<div class="input clearfix" style="border:none">
						   	          				     ...
						   	          				     <input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][links][limit]" value="<?php if(isset($column_module['links']['limit'])) echo $column_module['links']['limit']; ?>" style="width: 60px" <?php if($column_module['type'] != 'links') echo 'disabled="disabled"'; ?>>
						   	          				</div>
						   	          				...
						   	          				<table id="links-<?php echo $module_row; ?>-<?php echo $columns_count; ?>-<?php echo $s; ?>">
						   	          					...
						   	          					<tbody id="link-<?php echo $links; ?>">
						   	          					     <tr>
						   	          					          ...
						   	          					          <?php } ?>
					   	          					               ...
					   	          					               <?php foreach ($languages as $language) { ?>
					   	          					                    <div class="language">
					   	          					                         <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />
					   	          					                         <input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][links][array][<?php echo $links; ?>][url][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($link['url'][$language_id]) && is_array($link['url'])) { echo $link['url'][$language_id]; } else if(isset($link['url']) && !is_array($link['url'])) { echo $link['url']; } ?>">
					   	          					                    </div>
					   	          					               <?php } ?>
					   	          					               </div></td>
                                                                  ...
                                                                  <td><a onclick="$('#link-<?php echo $links; ?>').remove();" class="remove-link"><img src="view/image/module_template/delete-slider.png" alt=""/></a></td>
						   	          					     </tr>
						   	          					</tbody>
						   	          					<?php $links++; } } ?>
						   	          					<tfoot></tfoot>
						   	          				</table>
                                                    <a onclick="addLink(<?php echo $module_row; ?>, <?php echo $columns_count; ?>, <?php echo $s; ?>);" class="add-link"><span>Add<br> new</span></a>
						   	          			</div>
						   	          ...
						   	          <?php } ?>
						   	          				...
						   	          				<div class="input clearfix">
						   	          					...
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products][width]" value="<?php if(isset($column_module['products']['width'])) echo $column_module['products']['width']; ?>" style="width:60px;margin-right: 5px" <?php if($column_module['type'] != 'products') echo 'disabled="disabled"'; ?>>
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products][height]" value="<?php if(isset($column_module['products']['height'])) echo $column_module['products']['height']; ?>" style="width: 60px" <?php if($column_module['type'] != 'products') echo 'disabled="disabled"'; ?>>
						   	          				</div>
						   	          
						   	          				<div class="input clearfix">
						   	          					<p>Limit products:</p>
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products][limit]" value="<?php if(isset($column_module['products']['limit'])) echo $column_module['products']['limit']; ?>" style="width: 60px" <?php if($column_module['type'] != 'products') echo 'disabled="disabled"'; ?>>
						   	          				</div>
						   	          			</div>
						   	           ...
						   	           <?php } ?>
						   	              ...
						   	              <?php } ?>
						   	            				...
						   	            				<div class="input clearfix">
						   	            					<p>Image dimension (W x H) and Resize Type:</p>
						   	            					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products_tabs][width]" value="<?php if(isset($column_module['products_tabs']['width'])) echo $column_module['products_tabs']['width']; ?>" style="width:60px;margin-right: 5px" <?php if($column_module['type'] != 'products_tabs') echo 'disabled="disabled"'; ?>>
						   	            					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products_tabs][height]" value="<?php if(isset($column_module['products_tabs']['height'])) echo $column_module['products_tabs']['height']; ?>" style="width: 60px" <?php if($column_module['type'] != 'products_tabs') echo 'disabled="disabled"'; ?>>
						   	            				</div>
						   	            
						   	            				<div class="input clearfix">
						   	            					<p>Limit products:</p>
						   	            					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products_tabs][limit]" value="<?php if(isset($column_module['products_tabs']['limit'])) echo $column_module['products_tabs']['limit']; ?>" style="width: 60px" <?php if($column_module['type'] != 'products_tabs') echo 'disabled="disabled"'; ?>>
						   	            				</div>
						   	            				...
						   	            				<table id="products-tabs-<?php echo $module_row; ?>-<?php echo $columns_count; ?>-<?php echo $s; ?>">
						   	            					...
						   	            					<?php if(isset($column_module['products_tabs']['products'])) { foreach ($column_module['products_tabs']['products'] as $product) { ?>
						   	            					     ...
						   	            					     <tr>
                                                                       ...
                                                                       <td><a onclick="$('#product-tab-<?php echo $products_tabs; ?>').remove();" class="remove-link"><img src="view/image/module_template/delete-slider.png" alt=""/></a></td>
						   	            					     </tr>
						   	            					</tbody>
						   	            				...
						   	            				<a onclick="addProductTab(<?php echo $module_row; ?>, <?php echo $columns_count; ?>, <?php echo $s; ?>);" class="add-link"><span>Add<br> new</span></a>
						   	          			</div>
						   	          ...
						   	          <?php } ?>
						   	          				...
						   	          				<div class="input clearfix">
						   	          					<p>Image dimension (W x H) and Resize Type:</p>
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][latest_blogs][width]" value="<?php if(isset($column_module['latest_blogs']['width'])) echo $column_module['latest_blogs']['width']; ?>" style="width:60px;margin-right: 5px" <?php if($column_module['type'] != 'latest_blogs') echo 'disabled="disabled"'; ?>>
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][latest_blogs][height]" value="<?php if(isset($column_module['latest_blogs']['height'])) echo $column_module['latest_blogs']['height']; ?>" style="width: 60px" <?php if($column_module['type'] != 'latest_blogs') echo 'disabled="disabled"'; ?>>
						   	          				</div>
						   	          
						   	          				<div class="input clearfix">
						   	          					<p>Limit blogs:</p>
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][latest_blogs][limit]" value="<?php if(isset($column_module['latest_blogs']['limit'])) echo $column_module['latest_blogs']['limit']; ?>" style="width: 60px" <?php if($column_module['type'] != 'latest_blogs') echo 'disabled="disabled"'; ?>>
						   	          				</div>
						   	          			</div>
...
function addLink(module_row, column, modules) {
	...
	html += '			<div class="language">';
	html += '				<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />';
	html += '				<input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][links][array][' + links + '][url][<?php echo $language['language_id']; ?>]">';
	html += '			</div>';
	<?php } ?>
	html += '		</div></td>';
...
function addModuleToColumn(module_row, column) {
	...
	<?php foreach($templates as $template) {
	     if(isset($links_templates[$template])) {
	          ...
	          foreach($links_templates[$template] as $file_template) { ?>
	               html += '                         <div class="module-layout clearfix <?php if($file_template != 'default.tpl') { echo 'advanced'; } ?>">';
	...
	<?php foreach($templates as $template) {
	     if(isset($products_templates[$template])) {
	          ...
	          echo 'html += \'<div class="module-layout-title">' . $template . '</div>\';';
	          foreach($products_templates[$template] as $file_template) { ?>
	               html += '                         <div class="module-layout clearfix <?php if($file_template != 'default.tpl' && $file_template != 'products_grid.tpl') { echo 'advanced'; } ?>">';
	...
	<?php foreach($templates as $template) {
	     if(isset($products_tabs_templates[$template])) {
	          ...
	          echo 'html += \'<div class="module-layout-title">' . $template . '</div>\';';
	          foreach($products_tabs_templates[$template] as $file_template) { ?>
	               html += '                         <div class="module-layout clearfix <?php if($file_template != 'products_grid_with_carousel.tpl') { echo 'advanced'; } ?>">';
