                                   ...
                                   <div class="input clearfix">
                                   	...
                                   	<div class="list-language">
                                   	     ...
                                   	     <div class="language">
                                   	     	<?php $language_id = $language['language_id']; ?>
                                   	     	<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />
                                   	     	<input type="text" name="url[<?php echo $language_id; ?>]" <?php if(isset($url[$language_id]) && is_array($url)) { echo 'value="'.$url[$language_id].'"'; } else if(isset($url) && !is_array($url)) { echo 'value="'.$url.'"'; } ?>>
                                   	     </div>
                                   	     <?php } ?>
                                   	</div>
                                   </div>
