	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=extension/module/fastor&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
						...
						<div id="tab_product" class="tab-content">
							...
							<div class="section">
                                ...
                                <div class="input">
                                    ...
                                    <input type="text" name="new_products_label_limit" style="width:60px" value="<?php echo $new_products_label_limit; ?>" />
                                    <div class="clear"></div>
                                </div>
                            </div>
							<div class="section">
                                ...
                                <div class="section-content">
                                    <div class="input">
                                        ...
                                        <a href="http://themenis.com/opencart/fastor/doc" class="hint-tooltip" data-toggle="tooltip" title="Go to the documentation to se how it works" target="_blank"></a>
                                        <div class="clear"></div>
                                    </div>
                                    ...
                                    <div class="input">
                                    	...
                                    	<div class="list-language">
                                    		...
                                    		<div class="language select">
                                    			...
                                    			<?php
                                    				if ($handle = opendir('../catalog/view/theme/fastor/js/countdown/')) {
