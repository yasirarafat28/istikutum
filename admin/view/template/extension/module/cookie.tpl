							...
							<table class="form">
							  <tr>
							       ...
							       <td class="color_input">
                                       <input type="text" name="cookie_module[<?php echo $module_row; ?>][text_color]" class="colorpicker-input" value="<?php echo $module['text_color']; ?>"  />
                                       <span class="color_selected" <?php if($module['text_color'] != '') { echo 'style="background: ' . $module['text_color'] . '"'; } ?> ></span>
                                   </td>
							  </tr>
							  <tr>
							       <td>Border color:</td>
							       <td class="color_input">
                                       <input type="text" name="cookie_module[<?php echo $module_row; ?>][border_color]" class="colorpicker-input" value="<?php echo $module['border_color']; ?>" />
                                       <span class="color_selected" <?php if($module['border_color'] != '') { echo 'style="background: ' . $module['border_color'] . '"'; } ?> ></span>
                                   </td>
							  </tr>
							  <tr>
							       <td>Background color:</td>
                                   <td class="color_input">
                                       <input type="text" name="cookie_module[<?php echo $module_row; ?>][background_color]" class="colorpicker-input" value="<?php echo $module['background_color']; ?>"  />
