...
class ControllerBlogBlog extends Controller {
    ...
    public function __construct($registry) {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get($this->config->get('config_theme') . '_directory') . '/css/blog/blog.css')) {
            $this->document->addStyle('catalog/view/theme/' . $this->config->get($this->config->get('config_theme') . '_directory') . '/css/blog/blog.css');
        }
        if (file_exists(DIR_TEMPLATE . $this->config->get($this->config->get('config_theme') . '_directory') . '/js/masonry.pkgd.min.js')) {
            $this->document->addScript('catalog/view/theme/' . $this->config->get($this->config->get('config_theme') . '_directory') . '/js/masonry.pkgd.min.js');
        }
        if (file_exists(DIR_TEMPLATE . $this->config->get($this->config->get('config_theme') . '_directory') . '/js/imagesloaded.pkgd.min.js')) {
    ...
    public function index()
    {
        ...
        if(!empty($results)){
            ...
            if(isset($this->request->get['ajax_request']) && $this->request->get['ajax_request'] == 1){
                return $this->response->setOutput($this->load->view('blog/article_list/' . $this->settings['article_list_template'], $data));
            }
